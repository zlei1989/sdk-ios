...
class Activity : UIWindow {
    ...
    func didDeviceOrientation() {
        ...
        case .portrait:
            Logger.info("Device Orientation, Home to bottom")
        case .portraitUpsideDown:
            Logger.info("Device Orientation, Home to top")
        case .landscapeLeft:
            Logger.info("Device Orientation, Home to left")
        case .landscapeRight:
            Logger.info("Device Orientation, Home to right")
        case .faceDown:
            Logger.info("Device Orientation, Screen to down")
        case .faceUp:
            Logger.info("Device Orientation, Screen to up")
        default:
